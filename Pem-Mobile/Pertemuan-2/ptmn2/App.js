...
const PROFILE = {
  name: 'Indri Setiawati',
  title: 'Mahasiswa Informatika',
  email: 'indrisetiawati0830@gmail.com',
  phone: '081222884298',
  location: 'Cirebon, Jawa Barat',
  bio: 'Mahasiswa Informatika UIN yang tertarik pada pengembangan aplikasi mobile, web modern, dan eksplorasi teknologi informasi.',
  avatar: 'https://lh5.googleusercontent.com/-cWpQD7mxon4/AAAAAAAAAAI/AAAAAAAAAAA/c12tnQB-Tv4/s64-c-mo/photo.jpg',
};
...
const SECTIONS = [
  {
    title: '💼 Pengalaman Organisasi & Pelatihan',
    data: [
      {
        id: 'e1',
        role: 'Peserta Pelatihan Pemrograman',
        company: 'Kursus / Les Informatika Komputer',
        period: '2024 - Sekarang',
        desc: 'Mempelajari dasar logika pemrograman, pengembangan antarmuka web & mobile, serta praktik pembuatan proyek aplikasi.',
      },
      {
        id: 'e2',
        role: 'Staf Anggota Remaja Masjid',
        company: 'Remaja Masjid Miftahul Jannah',
        period: '2023 – 2024',
        desc: 'Mengelola publikasi konten digital, dokumentasi kegiatan keagamaan, serta membantu kelancaran kepanitiaan acara pemuda.',
      },
    ],
  },
  {
    ...
    data: [
      {
        ...
        period: '2024 – Sekarang',
        desc: 'Fokus mendalami rekayasa perangkat lunak, sistem basis data, algoritma komputasi, dan mobile programming.',
      },
      {
        id: 'd2',
        role: 'Jurusan MIPA',
        ...
        period: '2021 – 2024',
        desc: 'Aktif dalam kegiatan akademik sains serta pengenalan dasar-dasar ilmu komputer.',
      },
    ],
  },
];
...
const SOCIAL = [
  { id: 's1', label: 'GitHub', icon: '💻', url: 'https://github.com/iindrisw' },
  { id: 's2', label: 'LinkedIn', icon: '💼', url: 'https://www.linkedin.com/in/indri-setiawati-244037324' },
  { id: 's3', label: 'Instagram', icon: '📷', url: 'https://instagram.com/ay.joourn' },
  { id: 's4', label: 'Email', icon: '✉️', url: 'mailto:indrisetiawati0830@gmail.com' },
];
...
export default function App() {
  ...
  const showContactModal = (title, messageText, type = 'info') => {
    setContactModalTitle(title);
    setContactModalMessage(messageText);
      ...
      <Modal visible={contactModalVisible} transparent animationType="fade" onRequestClose={() => setContactModalVisible(false)}>
        <View style={styles.contactModalOverlay}>
          <View style={styles.contactModalBox}>
            <Text style={[styles.contactModalTitle, contactModalType === 'warning' ? styles.warningTitle : styles.successTitle]}>
              {contactModalTitle}
            </Text>
